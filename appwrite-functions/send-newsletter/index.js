                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                  <tr>
                    ...
                    <td style="vertical-align: middle; padding-left: 20px; text-align: center;">
                      ...
                      <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 6px 0;">
                        <tr>
                          <td width="45%" valign="middle">
                            <div style="border-top: 1px solid #a88b4a; line-height: 1px; height: 1px; font-size: 1px;">&nbsp;</div>
                          </td>
                          <td width="10%" valign="middle" align="center" style="color: #a88b4a; font-size: 16px; line-height: 16px; padding: 0;">&bull;</td>
                          <td width="45%" valign="middle">
                            <div style="border-top: 1px solid #a88b4a; line-height: 1px; height: 1px; font-size: 1px;">&nbsp;</div>
                          </td>
                        </tr>
                      </table>
                      <div style="font-size: 15px; font-weight: normal; color: #a88b4a; font-family: Georgia, 'Times New Roman', serif; letter-spacing: 1.5px; margin: 0; line-height: 1;">Publish Your Thoughts.</div>
                    </td>
                  </tr>
                </table>
              </a>
