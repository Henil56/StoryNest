        ...
        <div className='min-h-[80vh] flex items-center justify-center w-full px-4 page-enter'>
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-2xl shadow-xl overflow-hidden bg-surface-elevated animate-fade-in">
                ...
                <div className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-[#87CEEB] via-[#4682B4] to-[#17304D] text-white relative overflow-hidden">
                    {/* Floating decoration */}
                    <div className="absolute top-10 right-10 w-32 h-32 rounded-full bg-white/10 blur-xl animate-float"></div>
                    <div className="absolute bottom-20 left-10 w-24 h-24 rounded-full bg-white/5 blur-lg" style={{ animation: 'float 5s ease-in-out infinite 1s' }}></div>
                    
                    <div className="relative z-10">
                        <div className="text-5xl mb-6">🔑</div>
                        <h2 className="text-3xl font-bold leading-tight">Reset your<br/>password</h2>
                        <p className="mt-4 text-[#B0E0E6] text-lg leading-relaxed">Don't worry, it happens to the best of us. We'll help you get back in.</p>
